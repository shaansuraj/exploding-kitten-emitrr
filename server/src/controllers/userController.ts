...
// Initializing the user repository with the schema and create the index
...
const createToken = (id: string) => {
    const secret = process.env.SECRET; // Getting the secret from the environment variables
